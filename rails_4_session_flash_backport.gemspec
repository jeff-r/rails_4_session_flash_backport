...
Gem::Specification.new do |gem|
  gem.name          = "rails_4_session_flash_backport-streamsend"
  gem.version       = Rails4SessionFlashBackport::VERSION
  gem.authors       = ["Lucas Parry, Jeff Roush"]
  gem.email         = ["jroush@ezpublishing.com"]
  ...
  gem.homepage      = "https://github.com/Jeff-R/rails_4_session_flash_backport"
